...
`python backtest_data/prospective_selection.py` 只讀本機快照，從 2026-09-21
起的訊號開始累積。固定主要持有期20個快照交易日、診斷期5日；研究假設為
單邊費用15bps、賣出稅30bps、單邊滑價10/25bps，不代表個人實際交易費率。
腳本固定既有研究實作的SHA256（正規化換行）；改實作即拒絕沿用協議。
