...
每條格式（嚴格遵守）：
**【類股｜台灣/全球】公司或主題（一句話簡介）**：發生什麼（具體事件＋數字／來源媒體）＋ 影響（對該類股、相關台股或整體市場）＋ **資訊強度(A/B)＋信心(高/中/低)**

範例（皆為新聞事件，不是股價/法人數據）：
**【金融｜台灣】壽險業（國泰、富邦等大型壽險）**：金管會公布壽險業前 4 月稅後大賺約 1,945 億元、投資收益為最大推手（經濟日報）。利多壽險金控、對加權指數金融權值有撐。**[A 級・信心:中]**
**【金融｜全球】美國銀行股**：市場焦點由非農數據轉向通膨與 Fed 決策，地區銀行評價受關注（鉅亨）。若美債殖利率自高檔鬆動，有利金融股。**[B 級・信心:低，資訊有限]**
...
R12 的 A/B/C 級透明標記規則同樣適用；**不可**與 00662 / 2330 硬扯傳導。
