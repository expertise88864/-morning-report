...
OTHER_SECTOR_QUERIES: dict[str, str] = {
    "金融保險":     "台股 金融股 金控 銀行 壽險 升息 利率 獲利",
    "航運":         "台股 航運 貨櫃 散裝 空運 長榮 陽明 運價",
    "傳產原物料":   "台股 鋼鐵 塑化 水泥 紡織 原物料 報價 中鋼 台塑",
    "生技醫療":     "台股 生技 製藥 醫材 新藥 CDMO 藥華藥",
    "電信公用":     "台股 電信 中華電 台灣大 遠傳 油電 燃氣 電價 台塑化",
    "重電綠能":     "台股 重電 電網 綠能 儲能 風電 太陽能 士電 中興電",
    "觀光內需":     "台股 觀光 餐旅 飯店 食品 零售 百貨 晶華 統一超",
    "軍工汽車營建": "台股 軍工 國防 航太 漢翔 汽車 和泰車 建材營造 營建 興富發",
}
...
## 九、其他類股資訊（非科技類股；**6–10 條**，依當日有料的類股分配；沒料的類股直接略過，不要硬湊）

涵蓋科技以外的台股類股昨日重大動態，**取材見上方【其他類股最新新聞】**。**只寫當日真有重要消息(具體事件 / 數字 / 法人動向 / 政策)的類股**；無料的類股不要寫、不要用空泛句湊數。

涵蓋類股（有料才寫，每類至多 1-2 條）：金融保險、航運、傳產原物料(鋼鐵 / 塑化 / 水泥 / 紡織)、生技醫療、電信與公用(油電燃氣)、重電與綠能環保、觀光餐旅與食品內需零售、軍工航太、汽車、建材營造 / 營建資產。

每條格式（嚴格遵守）：
**【類股】公司或主題（一句話簡介）**：發生什麼（含數字 / 來源）+ 對該類股或台股大盤的影響 + **資訊強度(A/B)+ 信心(高/中/低)**

範例 A 級(具體事實):
**【金融】富邦金（2881，台灣最大金控）**：11 月自結稅後 EPS X 元、前 11 月累計 EPS Y 元創同期高，法人估全年配息上看 Z 元。利多金控權值、對加權指數有撐。**[A 級・信心:中]**

範例 A 級(具體事實):
**【重電】中興電（1513，重電統包與輸變電）**：標下台電 XX 億元輸變電統包案，在手訂單再墊高。反映電網升級需求延續，利多重電族群。**[A 級・信心:中]**

範例 B 級(只有方向性訊號):
**【觀光】晶華（2707，國際觀光飯店龍頭）**：僅頭條提及「年底訂房暢旺」(無原始數字)，屬方向性訊號。**[B 級・信心:低，資訊有限]**

**不可**與 00662 / 2330 硬扯傳導；非科技類股一律從「對該類股 / 台股大盤」的角度說明。R12 的 A/B/C 級透明標記規則同樣適用(只有「迎來轉折」「市場關注」這類沒內容的 C 級標題不要寫)。
