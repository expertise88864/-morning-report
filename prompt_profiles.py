...
DEEPSEEK_LEGACY_VERSION = 15  # 2026-09-03 全案審查 LM-7:圍欄內的取材指令搬到圍欄外(【圍欄內各段的取材對應與規則】),段標改中性;  # v14 2026-09-03 使用者七項(刪七之五/刪結論卡三行/前言守衛/台股為主/R16c);  # 2026-08-27 使用者七項(0050 行/七之二規則/行事曆解說);  # 2026-08-25 使用者:七之二要「後續可能影響」(長度重試不再壓成一行);  # 2026-08-22 金融龍頭+5; 2026-08-21 r2:選材規則移到圍欄外+無條件(v9 同批修訂)
...
LUNA_XHIGH_VERSION = 49  # v49 2026-09-03 使用者:整封信只講一個故事(結論卡不得引入正文沒出現的驅動因子)+ 傳導終點改台股;  # v48 2026-09-01:總經發布規則教複數(每一個未駁回×三分支+駁回出口),與判準端對齊
