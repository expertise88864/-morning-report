...
DEEPSEEK_LEGACY_VERSION = 14  # 2026-09-03 使用者七項(刪七之五/刪結論卡三行/前言守衛/台股為主/R16c);  # 2026-08-27 使用者七項(0050 行/七之二規則/行事曆解說);  # 2026-08-25 使用者:七之二要「後續可能影響」(長度重試不再壓成一行);  # 2026-08-22 金融龍頭+5; 2026-08-21 r2:選材規則移到圍欄外+無條件(v9 同批修訂)
