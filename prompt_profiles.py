...
DEEPSEEK_LEGACY_VERSION = 25  # Attributed fallback opinions are context, never evidence.
...
LUNA_XHIGH_VERSION = 61  # Attributed fallback opinions are context, never evidence.
