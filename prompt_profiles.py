...
DEEPSEEK_LEGACY_VERSION = 22  # Concise conclusion and cross-section editorial roles.
...
LUNA_XHIGH_VERSION = 57  # Concise conclusion and cross-section editorial roles.
