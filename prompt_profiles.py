...
DEEPSEEK_LEGACY_VERSION = 35  # Sept24: distinguish OI position size from directional evidence.
...
LUNA_XHIGH_VERSION = 68  # Sept24: separate layoffs from financing inference.
