...
DIAGNOSTIC_KEYS = (
    ...
    "news",
    # 中職場地補值的逐班結果(2026-08-24 外審 P3):CPBL 官網對 Actions 的
    # 海外 IP 可能 geo-block,那時賽程照出、場地永遠空,而信照樣寄成功。
    # 「本機測得到、生產可能永遠測不到」的功能要留得下痕跡 —— stderr
    # 隔天就沖掉了,只有 manifest 看得出它連續幾天沒有真的工作過。
    "sports",
