...
_FROZEN = {
    ...
    #     `taiwan_policy` 欄位說明。
    "primary_profile_version":  (48, "f2d5bf6dfe823a66"),  # v48 2026-09-01:總經發布教複數,兩關卡對齊  # v44 2026-08-24:公報可引用(gazette:<id>)  # v43 2026-08-22 使用者:類股加量(科技≥6/其他≥5)+術語首次出現要括號解釋  # v42 金融龍頭+5(2026-08-22)
    ...
    "fallback_profile_version":  (13, "683ded643c71ac7d"),  # v11 金融龍頭+5(2026-08-22)
