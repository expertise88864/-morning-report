...
_FROZEN = {
    ...
    "output_schema_version":  (23, "3ca56574e22ac2b0"),  # v22 敘事/總經證據契約(2026-08-19 P1-B)
    ...
    #     `taiwan_policy` 欄位說明。
    "primary_profile_version":  (46, "dbd000102486d5d8"),  # v44 2026-08-24:公報可引用(gazette:<id>)  # v43 2026-08-22 使用者:類股加量(科技≥6/其他≥5)+術語首次出現要括號解釋  # v42 金融龍頭+5(2026-08-22)
    ...
    "fallback_profile_version":  (12, "a7266089398df2c3"),  # v11 金融龍頭+5(2026-08-22)
