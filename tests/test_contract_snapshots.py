...
_FROZEN = {
    ...
    "output_schema_version":  (24, "63b248bfc32961b2"),  # v22 敘事/總經證據契約(2026-08-19 P1-B)
    ...
    #     `taiwan_policy` 欄位說明。
    "primary_profile_version":  (49, "764ba098eed2a393"),  # v49 2026-09-03 使用者:整封信只講一個故事+傳導終點改台股  # v48 2026-09-01:總經發布教複數,兩關卡對齊  # v44 2026-08-24:公報可引用(gazette:<id>)  # v43 2026-08-22 使用者:類股加量(科技≥6/其他≥5)+術語首次出現要括號解釋  # v42 金融龍頭+5(2026-08-22)
    ...
    "fallback_profile_version":  (14, "60dcf947358f0f32"),  # v14 2026-09-03 使用者七項(刪七之五/結論卡三行/前言守衛/台股為主/R16c)  # v11 金融龍頭+5(2026-08-22)
    ...
    "renderer_version":       (20, "e7ed2c6c9b219c19"),
