...
MODULE_CEILINGS = {
    ...
    "run_quality.py": 760,  # 2026-08-22 外審 P3:state:corrupt 家族的專屬 finding(說得出哪份壞了);現況 666  # 2026-08-22:luna_path_failed 家族豁免+失敗原因騎在 not_specialized 上;現況 636
    ...
    "run_manifest.py": 430,  # 2026-08-22 r1 外審 P2:corrupt 明細由 recorder 擁有(整段覆寫會吃掉留痕);現況 419   # 2026-08-07:luna_path_failure 加 traceback 記錄(+13 行)
