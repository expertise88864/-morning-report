...
MODULE_CEILINGS = {
    ...
    # 實測 1011。
    "event_identity.py": 1_240,  # 2026-08-26 r2:組織身分+縮寫大小寫規則;現況 1191  # 2026-08-26 r2:被動由「後面有沒有受詞」判;現況 1144  # 2026-08-26 外審:制裁受詞位置剖析(sanction:Oil);現況 1120  # 2026-08-22 r1 外審 P2:_subjects_meet 套 usable_alias(裸數字別名);現況 1041  # r2:主體正規化走單一權威+別名納入標題比對;現況 1025
    ...
    "entity_alias.py": 115,  # 2026-08-22 外審 P1:組代表成為持久鍵的一部分(重複組清理+契約說明);現況 101
