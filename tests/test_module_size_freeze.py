...
MODULE_CEILINGS = {
    ...
    "analysis_validate.py": 1_210,  # 2026-09-03 全案審查 LM-2/3/4:空欄位檢查、_q 截斷、weakly_corroborated 共用述詞(+59,全是 bug fix);前值 1_150,  # v22 敘事/總經證據檢查;現況 1089,    # 2026-08-08 外審 P1-8:key-driver 反證也要驗
