...
MODULE_CEILINGS = {
    ...
    "analysis_validate.py": 1_220,  # 2026-09-04 實信:空 why_it_matters 的卡片靜默消失 —— 驗證器擋(+9,bug fix);前值 1_210,  # 2026-09-03 全案審查 LM-2/3/4:空欄位檢查、_q 截斷、weakly_corroborated 共用述詞(+59,全是 bug fix);前值 1_150,  # v22 敘事/總經證據檢查;現況 1089,    # 2026-08-08 外審 P1-8:key-driver 反證也要驗
    ...
    "analysis_depth.py": 830,  # 2026-08-25 外審 P2:逐段可行性(拆掉全域門檻)+素材面只算認得出主體的;現況 793  # 2026-08-24 外審 r3:涵蓋率缺口的雙向規則(該在不在/不該在還在);現況 763
