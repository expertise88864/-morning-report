...
MODULE_CEILINGS = {
    ...
    "run_quality.py": 790,  # 2026-08-22 外審 P3:state:corrupt 家族的專屬 finding(說得出哪份壞了);現況 666  # 2026-08-22:luna_path_failed 家族豁免+失敗原因騎在 not_specialized 上;現況 636
    ...
    "analysis_validate.py": 1_150,  # v22 敘事/總經證據檢查;現況 1089,    # 2026-08-08 外審 P1-8:key-driver 反證也要驗
