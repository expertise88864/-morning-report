...
MODULE_CEILINGS = {
    ...
    "state_store.py": 110,
    "news_events.py": 1_430,  # 2026-08-22 外審 P1-2:別名/literal 共用 _usable_alias(裸數字不算指名);現況 1409
    ...
    # 實測 187 行。
    "state_migrations.py": 480,  # 2026-08-22 外審 r1 P1:遷移改用 producer 的對象權威(action_object);現況 467
    ...
    "analysis_depth.py": 660,  # 2026-08-22 外審 r4:缺口出口改宣告式代號(關鍵字比對讓守衛等於不存在);現況 631
