...
本段只寫新增證據如何改變解讀，不重抄上一段的時間線、數字與事件摘要。
價格反彈不證明需求改善，先後發生不證明因果；沒有來源直接支持時，不寫「真正原因」
或「證明」。把可能解釋標為推論，並列仍未排除的其他因素與待確認證據。

### 下週關注方向
3-4 條:本週懸而未決的事(談判/財報/數據/政策)下週會怎麼收斂、看什麼訊號。
只能從上方素材延伸,**不得編造下週的行事曆項目**。
分為「已知日期事件」與「未定期觀察條件」：前者須有來源支持的下週日期，沒有就省略；
後者寫可確認或推翻原解讀的具體訊號，不把一般關注主題包裝成已排定事件，也不逐項重複「時間未定」。
